                ...
                <div class="box-body">
                    ...
                    <form action="{{ route('materials.update', $material->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"  name="material_name" class="form-control" value="{{ $material->material_name }}">
                        </div>
                        ...
                        <div class="form-group">
                            <label>الكميه</label>
                            <input type="number" step="0.01" name="amount" class="form-control" value="{{ $material->amount }}">
                        </div>

                        <div class="form-group">
                            <label>سعر الوحده</label>
                            <input type="number" step="0.01" name="unit_price" class="form-control" value="{{ $material->unit_price }}">
                        </div>

                        <div class="form-group">
                            <label> المدفوع</label>
                            <input type="number" step="0.01" name="paid" class="form-control" value="{{ $material->paid }}">
                        </div>
